if shared.VapeExecuted then
	local VERSION = "69.UwU"..(shared.VapePrivate and " PRIVATE" or " PRIVATE").." "..readfile("FapeClient/commithash.txt"):sub(1, 7)
	...
	GuiLibrary.LoadSettings = function(customprofile)
		...
		if isfile("FapePrivate/Profiles/"..(game.GameId).."GUIPositions.vapeprofile.txt") == false and isfile("FapeClient/Profiles/"..(game.GameId).."GUIPositions.vapeprofile.txt") then
			writefile("FapePrivate/Profiles/"..(game.GameId).."GUIPositions.vapeprofile.txt", readfile("FapeClient/Profiles/"..(game.GameId).."GUIPositions.vapeprofile.txt"))
		end
		if isfile("FapePrivate/Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".vapeprofiles.txt") == false and isfile("FapeClient/Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".vapeprofiles.txt") then
			writefile("FapePrivate/Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".vapeprofiles.txt", readfile("FapeClient/Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".vapeprofiles.txt"))
		end
		--end
	...
	GuiLibrary["CreateMainWindow"] = function()
		...
		windowapi["CreateCustomToggle"] = function(argstable)
			...
			GuiLibrary.ObjectsThatCanBeSaved["FapeClientSettings"..argstable["Name"].."Toggle"] = {["Type"] = "Toggle", ["Object"] = buttontext, ["Api"] = buttonapi}
			return buttonapi
		end
